...
filepath = "weights-improvement-transfer-learning-tf-{epoch:02d}-{val_acc:.2f}.h5"
checkpoint = ModelCheckpoint(filepath, monitor='val_acc', verbose=1, save_best_only=True, mode='max')
callbacks_list = [checkpoint]

history = model.fit(batch_size=50, x=X_train, y=y_train, verbose=1, epochs=10, shuffle=True,
